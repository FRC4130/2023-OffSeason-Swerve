...
public class SwerveModule {
    ...
    public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants){
        ...
        angleEncoder = new CANCoder(moduleConstants.cancoderID, "CTRE Chain");
        configAngleEncoder();

        /* Angle Motor Config */
        mAngleMotor = new TalonFX(moduleConstants.angleMotorID, "CTRE Chain");
        configAngleMotor();
        
        /* Drive Motor Config */
        mDriveMotor = new TalonFX(moduleConstants.driveMotorID, "CTRE Chain");
        configDriveMotor();
